  ...
  return (
    <div>
      ...
      <p className="subheading">
        Hola! Soy Cristan. Soy Ingeniero en Sistemas (UAI 2014) y vivo en San Nicolas, Buenos Aires, Argentina.<br />
        ...
        y Blockchain donde he realizados varias PoC en la red de Ethereum.
      </p>
    </div>
  )
}
